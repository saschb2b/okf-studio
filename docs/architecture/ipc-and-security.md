...
| `pick_agent_text_sources(limit)` | Open the native text/Markdown picker, read bounded UTF-8 content in Rust, and return filename-labelled sources without absolute paths. |
