...
The top-left of the [top bar](../ux/browsing-layout.md) names the **currently open bundle**. Click it and a popover opens for switching context: to another bundle detected in the open folder, to a recently-opened bundle, or to a brand-new folder. The switcher consolidates two scattered surfaces, the old sidebar bundle list and the recent list buried in [Settings](../ux/settings.md). Switching context becomes an always-visible action, in the spirit of Zed's project switcher.
