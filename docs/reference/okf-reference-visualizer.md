...
description: Google's single self-contained HTML consumer, which renders any OKF bundle as a force-directed graph. OKF Studio is the native desktop counterpart to this reference implementation.
